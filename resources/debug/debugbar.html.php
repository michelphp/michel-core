...
<div id="__michel_debug_app"></div>
<template id="__michel_debug_template">
    <style>
...
<script>
    (function() {
        const host = document.getElementById('__michel_debug_app');
        const template = document.getElementById('__michel_debug_template');
